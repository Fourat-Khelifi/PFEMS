 ...
 */
router.post(
  "/signup/supervisor-company",
  signupLimiter,
  validate(companySupervisorSignupSchema),
  authController.signupCompanySupervisor,
);
/**
 * @swagger
 ...
 */
router.post(
  "/signup/supervisor-university",
  signupLimiter,
  validate(universitySupervisorSignupSchema),
  authController.signupUniversitySupervisor,
);
/**
 * @swagger
